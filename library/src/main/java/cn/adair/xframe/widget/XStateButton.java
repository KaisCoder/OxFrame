...
public class XStateButton extends AppCompatTextView {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.XStateButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.XStateButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.XStateButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.XStateButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.XStateButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.XStateButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.XStateButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.XStateButton_unableBackgroundColor, 0);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.XStateButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.XStateButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.XStateButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.XStateButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.XStateButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.XStateButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.XStateButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.XStateButton_unableStrokeColor, 0);
        setStroke();
